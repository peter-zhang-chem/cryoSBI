...
class ResNet18_Encoder(nn.Module):
    def __init__(self, out_dim: int):
        ...
        self.resnet.fc = nn.Linear(in_features=512, out_features=out_dim, bias=True)
...
class ConvNet_Encoder(nn.Module):
    def __init__(self, out_dim: int):
        ...
        self.convnet.classifier[2] = nn.Linear(
            in_features=768, out_features=out_dim, bias=True
        )
...
class RegNetX_Encoder(nn.Module):
    def __init__(self, out_dim: int):
        ...
        self.regnetx.fc = nn.Linear(in_features=1008, out_features=out_dim, bias=True)
...
class EfficientNet_Encoder(nn.Module):
    def __init__(self, out_dim: int):
        ...
        self.linear = nn.Linear(1536, out_dim)
...
class RegNetY_Encoder(nn.Module):
    def __init__(self, out_dim: int):
        ...
        self.regnety.fc = nn.Linear(in_features=888, out_features=out_dim, bias=True)
...
class ShuffleNet_Encoder(nn.Module):
    def __init__(self, out_dim: int):
        ...
        self.shuffle_net.fc = nn.Linear(
            in_features=1024, out_features=out_dim, bias=True
        )
